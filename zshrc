...
# Flutter Path
export PATH="/home/ola/.flutter_install/flutter/bin:$PATH"
...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting zsh-completions zsh-256color k)
...
alias n="neofetch"
alias zdir="cd ~/.oh-my-zsh/custom/plugins/"
